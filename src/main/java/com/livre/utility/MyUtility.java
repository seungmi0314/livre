...
import com.livre.common.SuperController;
import com.oreilly.servlet.MultipartRequest;
import com.livre.utility.CustomFileRenamePolicy;
...
public class MyUtility {
	...
	public static void deleteOldImageFile(String imageUploadWebPath, MultipartRequest mr) {
		...
		/*
		 * String[] deleteImages = { mr.getParameter("deleteImage01"),
		 * mr.getParameter("deleteImage02"), mr.getParameter("deleteImage03") };
		 * 
		 * for(String delFile : deleteImages) { if(delFile != null) { String deleteFile
		 * = imageUploadWebPath + "/" + delFile ; File target = new File(deleteFile);
		 * if(target.delete()) { System.out.println(deleteFile +
		 * " file delete success"); } } }
		 */
		
		String deleteImage = mr.getParameter("memberImg");

		if(deleteImage != null) {
		    String deleteFile = imageUploadWebPath + "/" + deleteImage;
